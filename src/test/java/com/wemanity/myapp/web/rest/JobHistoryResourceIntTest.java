...
import com.wemanity.myapp.repository.JobHistoryRepository;
import com.wemanity.myapp.repository.search.JobHistorySearchRepository;
import com.wemanity.myapp.service.JobHistoryService;
...
import static com.wemanity.myapp.web.rest.TestUtil.createFormattingConversionService;
...
import com.wemanity.myapp.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIntTest {
     ...
     *
     * @see com.wemanity.myapp.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
